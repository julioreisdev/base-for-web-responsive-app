...
const Sidebar: React.FC<IProps> = ({ children }) => {
  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      >
        <DrawerHeader>
          <h3 style={{ color: context?.colors.blueDark || "" }}>Título</h3>
      ...
      <Box
        ...
        sx={{
          ...
          p: 3,
          width: `calc(100vw  - ${
            localStorage.getItem("sidebar") === "open" ? "240px" : "65px"
          })`,
        }}
      >
      ...
      <Menu
        PaperProps={{
          sx: {
            backgroundColor: context?.colors.background, // Cor de fundo do conteúdo
          },
        }}
        anchorEl={anchorEl}
        open={!!anchorEl}
